...
function setup() {
    let grassEaterCounter = 2;
    let predatorCounter = 1;
    let humanCounter = 3

    let maxGrassEaterCounter = 90
    let maxPredatorCounter = 30
    let maxHumanCounter = 55
    ...
    createCanvas(matrix[0].length * side, matrix.length * side + 0);
    background('#acacac');
